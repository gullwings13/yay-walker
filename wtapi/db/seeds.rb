...
point1u1 = Point.create(
    lat: 40.740019, 
    long: -73.990045, 
    order: 1, 
    text: Faker::Hipster.paragraph(sentence_count: 2), 
    picture_url: 'https://source.unsplash.com/random/1920x1080/?nature,water,hike&sig=2')

point2u1 = Point.create(
    lat: 40.740058, 
    long: -73.989581, 
    order: 1, 
    text: Faker::Hipster.paragraph(sentence_count: 2), 
    picture_url: 'https://source.unsplash.com/random/1920x1080/?nature,water,hike&sig=3')

point3u1 = Point.create(
    lat: 40.740574, 
    long: -73.989440, 
    order: 1, 
    text: Faker::Hipster.paragraph(sentence_count: 2), 
    picture_url: 'https://source.unsplash.com/random/1920x1080/?nature,water,hike&sig=4')
...
3.times do
    ...
    2.times do
        tour = Tour.create(
            ...
            img_url: 'https://source.unsplash.com/random/1920x1080/?nature,water,hike&sig='+rand(2000).to_s)
        ...
        3.times do
            point1 = Point.create(
                ...
                order: 1, 
                text: Faker::Hipster.paragraph(sentence_count: 1), 
                picture_url: 'https://source.unsplash.com/random/1920x1080/?nature,water,hike&sig='+rand(2000).to_s)
